...
export function HeroSection() {
  return (
    <section id="hero" className="min-h-[100dvh] relative flex flex-col justify-between items-center pt-14 sm:pt-20 pb-6 sm:pb-10 px-4 sm:px-12 overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto relative z-20 flex flex-col sm:flex-row items-center sm:items-end justify-between gap-5 sm:gap-6 pt-4 sm:pt-6 border-t border-white/10">
        {/* Left Subtitle Bio */}
        <motion.div
        ...
        >
          <p className="text-[11px] sm:text-sm font-bold tracking-[0.16em] sm:tracking-[0.2em] text-slate-200 uppercase leading-relaxed drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
